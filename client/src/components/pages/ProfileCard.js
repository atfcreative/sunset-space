            ...
            <div className="row">
              ...
              <div className="text-center">
                ...
                <div className="panel panel-default">
                    <div className="panel-heading">{items.website}
                          ...
                          <form className="form" onSubmit={this.handleSubmit} method="post" id="registrationForm">
                              <div className="form-group">
                                  ...
                                  <div className="col-xs-6">
                                      <label forhtml="first_name"><h4>First Name: {items.firstName}</h4></label>
                              ...
                              <div className="form-group">
                                  ...
                                  <div className="col-xs-6">
                                    <label forhtml="last_name"><h4>Last Name: {items.lastName}</h4></label>
                              ...
                              <div className="form-group">
                                  ...
                                  <div className="col-xs-6">
                                      <label forhtml="phone"><h4>Phone: {items.phone}</h4></label>
                              ...
                              <div className="form-group">
                                  ...
                                  <div className="col-xs-6">
                                      <label forhtml="email"><h4>Email: {items.email}</h4></label>
                              ...
                              <div className="form-group">
                                  ...
                                  <div className="col-xs-6">
                                      <label forhtml="username"><h4>Username: {items.username}</h4></label>
                              ...
                              <div className="form-group">
                                  ...
                                  <div className="col-xs-6">
                                      <label forhtml="password"><h4>Reset Password</h4></label>
                              ...
                              <div className="form-group">
                                  ...
                                  <div className="col-xs-6">
                                    <label forhtml="password2"><h4>Verify Password</h4></label>
